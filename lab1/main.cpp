                     ...
                     int nCmdShow)
{
    ...
    wincl.hbrBackground = CreateSolidBrush(RGB(46,139,87)); // SETTING BACKGROUND COLOR
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    static HWND textArea1, buttonSubmit, buttonClear,
           textArea2, buttonRed, buttonGreen, buttonBlue, static1;
    ...
    switch (message)                  /* handle the messages */
    {
        case WM_CREATE:
        {
            static1 = CreateWindow (TEXT ("STATIC"), TEXT ("Literally comic text!"),
            ...
            SendMessage(textArea1, WM_SETTEXT, NULL, (LPARAM)"Input text");
        ...
        case WM_PAINT:
        {
            ...
            temp3 = CreateFont(25, 0, 0, 0, FW_DONTCARE, false, false, false,
                                    DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS,
                                    DEFAULT_QUALITY, FF_DONTCARE, "Comic Sans MS");
            SendMessage (static1, WM_SETFONT, (WPARAM) temp3, TRUE);
        ...
        case WM_SIZE:
        {
            ...
            MoveWindow(textArea1, 20, 45, cxCoord-40, cyCoord/2-100, TRUE);

            MoveWindow(buttonSubmit, 20,          cyCoord/2-50, cxCoord/2-40, cyCoord/2-130, TRUE);
            MoveWindow(buttonClear, cxCoord/2+20, cyCoord/2-50, cxCoord/2-40, cyCoord/2-130, TRUE);

            MoveWindow(textArea2, 20, cyCoord-170, cxCoord-40, 100, TRUE);

            MoveWindow(buttonRed, 20,               (cyCoord-50), cxCoord/3-40, 30, TRUE);
            MoveWindow(buttonBlue, cxCoord/3+20,    (cyCoord-50), cxCoord/3-40, 30, TRUE);
            MoveWindow(buttonGreen, 2*cxCoord/3+20, (cyCoord-50), cxCoord/3-40, 30, TRUE);
            MoveWindow (static1, 0, 0, cxCoord, 30, TRUE);
            break;
        }
        ...
        case WM_CTLCOLOREDIT:
        {
            ...
            {
                textArea1Brush = CreateSolidBrush(RGB(250,128,114));
