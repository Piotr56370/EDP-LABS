                     ...
                     int nCmdShow)
{
    ...
    wincl.hbrBackground = (HBRUSH) CreateSolidBrush(RGB(46,139,87));
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)                  /* handle the messages */
    {
        ...
        case WM_CLOSE:
            if(MessageBox(hwnd, "Do you want to exit the application?", "Close?", MB_YESNO) == IDYES) PostQuitMessage (0);
            break;
